...
},
{
  ...
  "body": " Negating statements  The negation of the statement, Courtney has five cats is the statement, It is not the case that Courtney havs five cats, or, Courtney doesn't have five cats.   "
},
{
...
},
{
  ...
  "number": "1.1.6",
  "title": "",
  "body": " Consider the unambiguously false statement, A banana is a natural number. Then the statement, A banana is a natural number and is false no matter what statement follows the and. In order for a conjunction of two statements to be true, both constituent statements must be true.  "
},
{
...
},
{
  "id": "app-sets-8-3-3",
  "level": "2",
  "url": "app-sets.html#app-sets-8-3-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "disjoint disjoint union "
},
{
